package com.berdachuk.expertmatch.graph.rest;
...
public class GraphVisualizationController {
     ...
     * @param vertexType   Optional filter by vertex type (e.g., Expert, Project)
    ...
    public ResponseEntity<Map<String, Object>> getGraphData(
            ...
            @Parameter(description = "Filter by vertex type (e.g., Expert, Project)", example = "Expert")
