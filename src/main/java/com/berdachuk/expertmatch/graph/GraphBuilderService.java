...
public class GraphBuilderService {
    ...
    public GraphBuilderService(NamedParameterJdbcTemplate namedJdbcTemplate, GraphService graphService) {
    ...
    /**
     * Data class for participation relationships used in batch operations.
     */
    public record ParticipationRelationship(String expertId, String projectId, String role) {
        public ParticipationRelationship(String expertId, String projectId, String role) {
    ...
    /**
     * Data class for project-technology relationships used in batch operations.
     */
    public record ProjectTechnologyRelationship(String projectId, String technologyName) {
    }

    /**
     * Data class for expert-customer relationships used in batch operations.
     */
    ...
    /**
     * Data class for project-customer relationships used in batch operations.
     */
