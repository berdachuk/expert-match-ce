...
class EmployeeRepositoryIT extends BaseIntegrationTest {
    ...
    void testFindByIds() {
        ...
        // Test findByIds
        List<EmployeeRepository.Employee> employees = employeeRepository.findByIds(List.of(id1, id2));
    ...
    void testFindByIdsEmpty() {
        List<EmployeeRepository.Employee> employees = employeeRepository.findByIds(List.of());
        assertNotNull(employees);
