...
import com.berdachuk.expertmatch.query.QueryExamplesService.QueryExample;
...
class QueryExamplesServiceTest {
    ...
    private final QueryExamplesService service = new QueryExamplesService(objectMapper);
