...
import com.berdachuk.expertmatch.chat.ConversationHistoryManager;
...
import com.berdachuk.expertmatch.retrieval.DeepResearchService;
...
public class QueryService {
    ...
    public QueryResponse processQuery(QueryRequest request, String chatId, String userId) {
        ...
        QueryParser.ParsedQuery parsedQuery = queryParser.parse(request.query(), useRoutingPattern, tracer);
     ...
     */
    private double calculateConfidence(HybridRetrievalService.RetrievalResult retrievalResult) {
