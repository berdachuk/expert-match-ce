...
public class TestDataGenerator {
    ...
    private String generateBankingResponsibilities(String role, List<String> technologies, String projectType) {
        StringBuilder sb = new StringBuilder();
        sb.append("Developed and maintained ").append(projectType.toLowerCase()).append(" using ");
        sb.append(String.join(", ", technologies.subList(0, Math.min(3, technologies.size()))));
        sb.append(". ");
        sb.append("Ensured compliance with banking regulations and security standards. ");
        sb.append("Implemented secure transaction processing and data protection mechanisms. ");
        sb.append("Collaborated with compliance and risk management teams.");
        return sb.toString();
    }
    ...
    private String generateHealthcareResponsibilities(String role, List<String> technologies, String projectType) {
        ...
        sb.append(String.join(", ", technologies.subList(0, Math.min(3, technologies.size()))));
        sb.append(". ");
        sb.append("Ensured HIPAA compliance and patient data security. ");
        sb.append("Integrated with EHR systems and healthcare interoperability standards (HL7, FHIR). ");
        sb.append("Collaborated with clinical staff and healthcare IT teams.");
        return sb.toString();
    }
