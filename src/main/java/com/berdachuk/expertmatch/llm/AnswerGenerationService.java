...
import com.berdachuk.expertmatch.query.ExecutionTrace;
import com.berdachuk.expertmatch.query.ExecutionTracer;
import com.berdachuk.expertmatch.query.ModelInfoExtractor;
import com.berdachuk.expertmatch.query.TokenUsageExtractor;
...
public class AnswerGenerationService {
    ...
    public AnswerGenerationService(@Lazy ChatClient chatClient, PromptTemplate ragPromptTemplate, ChatModel chatModel, Environment environment) {
    ...
    private String buildRAGPrompt(String query, List<ExpertContext> expertContexts, String intent,
        ...
        if (hasConversationHistory) {
            ...
            for (ConversationHistoryRepository.ConversationMessage message : conversationHistory) {
