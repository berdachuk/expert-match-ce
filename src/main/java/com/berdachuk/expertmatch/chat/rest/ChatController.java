package com.berdachuk.expertmatch.chat.rest;
...
public class ChatController implements ChatsApi {
    ...
    public ResponseEntity<com.berdachuk.expertmatch.api.model.Chat> createChat(
        ...
        com.berdachuk.expertmatch.chat.domain.Chat domainChat = chatService.createChat(userId, name);
    ...
    public ResponseEntity<com.berdachuk.expertmatch.api.model.ChatListResponse> listChats(
        ...
        // Use xUserId from parameter or fallback to userContext
        String userId = xUserId != null && !xUserId.isBlank() ? xUserId : userContext.getUserIdOrAnonymous();
        List<com.berdachuk.expertmatch.chat.domain.Chat> domainChats = chatService.listChats(userId);
    ...
    public ResponseEntity<com.berdachuk.expertmatch.api.model.Chat> getChat(
        ...
        Optional<com.berdachuk.expertmatch.chat.domain.Chat> domainChat = chatService.findChat(chatId);

        if (domainChat.isEmpty()) {
            throw new com.berdachuk.expertmatch.core.exception.ResourceNotFoundException(
                    "CHAT_NOT_FOUND",
    ...
    public ResponseEntity<com.berdachuk.expertmatch.api.model.Chat> updateChat(
        ...
        return chatService.findChat(chatId)
                ...
                .orElseThrow(() -> new com.berdachuk.expertmatch.core.exception.ResourceNotFoundException(
                        "CHAT_NOT_FOUND",
                        "Chat not found after update: " + chatId
                ));
    }
    ...
    public ResponseEntity<com.berdachuk.expertmatch.api.model.DeleteChatResponse> deleteChat(
        ...
        if (!deleted) {
            throw new com.berdachuk.expertmatch.core.exception.RetrievalException(
                    "DELETE_CHAT_ERROR",
