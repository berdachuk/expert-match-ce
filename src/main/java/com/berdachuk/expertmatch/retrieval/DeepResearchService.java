...
import com.berdachuk.expertmatch.query.*;
...
public class DeepResearchService {
    ...
    public HybridRetrievalService.RetrievalResult performDeepResearch(
        ...
        HybridRetrievalService.RetrievalResult initialResult = retrievalService.retrieve(request, parsedQuery, tracer);
        ...
        List<QueryResponse.ExpertMatch> initialExperts = enrichmentService.enrichExperts(initialResult, parsedQuery);
        ...
        List<HybridRetrievalService.RetrievalResult> expandedResults = new ArrayList<>();
        for (int i = 0; i < refinedQueries.size(); i++) {
            ...
            try {
                ...
                QueryParser.ParsedQuery expandedParsedQuery = new QueryParser.ParsedQuery(refinedQuery, List.of(), List.of(), null, "expert_search", List.of());
        ...
        HybridRetrievalService.RetrievalResult synthesizedResult =
     ...
     */
    private HybridRetrievalService.RetrievalResult synthesizeResults(
            HybridRetrievalService.RetrievalResult initial,
            List<HybridRetrievalService.RetrievalResult> expandedResults,
            int maxResults) {
        ...
        for (HybridRetrievalService.RetrievalResult expanded : expandedResults) {
        ...
        return new HybridRetrievalService.RetrievalResult(synthesizedIds, finalScores);
    }
